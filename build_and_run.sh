...
${VULKAN_SDK}/x86_64/bin/glslc ../src/shaders/render/render_state.vert -o ../target/shaders/render_state_vs.spv
${VULKAN_SDK}/x86_64/bin/glslc ../src/shaders/render/render_state.frag -o ../target/shaders/render_state_fs.spv
